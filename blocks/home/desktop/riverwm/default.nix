...
with lib.my;
let
  cfg = config.blocks.desktop.riverwm;
in
{
  options.blocks.desktop.riverwm = with types; {
    enable = mkOpt bool false;
  };

  config = mkIf cfg.enable {
    blocks.desktop.windowManager.name = "river";
    ...
    xdg.configFile."river/init" = {
      ...
      text = ''
        ...
        riverctl map normal Super+Shift Return spawn ${config.defaults.terminal}
