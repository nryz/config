...
let
  ...
  settings = ''
    ...
    config.bind(",M", "spawn mpv {url} --title='youtube' --pause --no-sub-visibility --ytdl-format=bestvideo[height<=?1080]+bestaudio/best", mode="normal")
    config.bind(",m", "hint links spawn mpv {hint-url} --title='youtube' --pause --no-sub-visibility --ytdl-format=bestvideo[height<=?1080]+bestaudio/best", mode="normal")
    config.bind(";m", "hint --rapid links spawn umpv {hint-url} --title='youtube' --pause --no-sub-visibility", mode="normal")
